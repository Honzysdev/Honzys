...
const playerSentences = {
    Nightblade: [
        ...
        "Do you want to know how to traumatize, Nightblade? Well wait a few weeks and find out!😂"
    ],
...
const _u = [
    ["SG9uenlz", "YWRtaW5kZXY="],
    ["TmlnaHRibGFkZQ==", "Y2xpZmZoYW5nZWQ="],
    ["S2VuemE=", "dGhlbWVuYWNl"],                   //more in notesblock
    ["QW50aG9ueQ==", "dGhlYmVzdG1vZA=="],
    ["TGlnaHQ=", "bW9zdGFjdGl2ZW1vZA=="],
    ["VHVtdHVt", "c2tpbmRlc2lnbmVy"]
];
...
document.getElementById("loginBtn").addEventListener("click", function (e) {
    ...
    const specialIcon = {
        Honzys: {src: "pics/adminlogo.png", tooltip: "Admin"},
        Nightblade: {src: "pics/supportlogo.png", tooltip: "Ideas support"}
    }

    const usernameDecoded = _d(ok[0]);

    document.getElementById('userName').textContent = usernameDecoded;
    document.getElementById('userPfp').src = avatarSource[usernameDecoded];
    document.getElementById('loggedIn').style.display = "flex";
    
    if (specialIcon[usernameDecoded]) {
    const icon = specialIcon[usernameDecoded];
...
const avatarSource = {
    Honzys: "pics/honzyspfp.png",
    Nightblade: "pics/nightbladespfp.png",
    Light: "pics/lightspfp.png",
    Kingmemo47: "pics/memospfp.png",
    Tumtum: "pics/tumtumspfp.png",
    Kenza: "pics/kenzaspfp.png",
    Meda: "pics/medaspfp.png",
    Anthony: "pics/anthonyspfp.png"
}
